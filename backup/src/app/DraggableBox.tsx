  ...
  return (
    ...
    >
      <div
        ref={nodeRef}
        data-node-id={nodeId}
        className={`relative w-48 h-48 text-white p-4 rounded-2xl shadow-lg ${className}`}
        style={{
          // Use block.jpg from /public
      ...
      >
        {/* Drag Handle */}
        <div
          className="drag-handle cursor-move absolute top-0 left-0 right-0 h-8 rounded-t-2xl flex justify-between items-center px-2"
          style={{ backgroundColor: "rgba(0, 0, 0, 0.3)" }}
        >
          <h3 className="text-white text-sm">{nodeId}</h3>
        </div>
